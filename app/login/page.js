...
import { Col, Input, Row, Space, Spin, Button } from "antd";
      ...
      <Col xl={23} xxl={23} sm={24} xs={24} lg={23}>
        <Row justify="center" gutter={[0, 24]}>
            ...
            <div className=" flex flex-col mt-20 justify-center items-center">
              <div className="h-48 md:h-96 w-48 sm:w-3/4">
                <Row justify="space-between" gutter={[12, 12]}>
                  <Col
                    span={11}
                    className="border-animate relative overflow-hidden border-2 h-24 sm:h-56 w-16 sm:w-52 rounded-3xl p-4 text-center"
                    style={{ backgroundColor: "rgba(255, 187, 17, 0.3)" }}
                  >
                    <div className=" absolute z-30 text-wrap px-6 text-black text-sm sm:text-2xl font-bold">
                  ...
                  <Col
                    span={11}
                    className="border-animate relative overflow-hidden border-2 h-24 sm:h-56 w-16 sm:w-52 rounded-3xl p-4 text-center"
                    style={{ backgroundColor: "rgba(155, 180, 10, 0.3)" }}
                  >
                    <div className=" absolute z-30 text-wrap px-6 text-black text-sm sm:text-2xl font-bold">
                      3.8 Crore+ Businesses Listed
                    </div>
                    <Player src='/BusinessList/web.json' loop autoplay className=' absolute top-16 left-1/3 -z-10 sm:z-0 w-full sm:w-2/4' />
                  </Col>
                  <Col
                    span={11}
                    className="border-animate relative overflow-hidden border-2 h-24 sm:h-56 w-16 sm:w-52 rounded-3xl bg-red-200 p-4 text-center"
                  >
                    <div className=" absolute z-30 text-wrap px-6 text-black text-sm sm:text-2xl font-bold">
                  ...
                  <Col
                    span={11}
                    className="border-animate relative overflow-hidden border-2 h-24 sm:h-56 w-16 sm:w-52 rounded-3xl bg-orange-100 p-4 text-center"
                  >
                    <div className=" absolute z-30 text-wrap px-6 w-full text-center text-black text-sm sm:text-2xl font-bold">
          ...
          <Col xl={10} xxl={10} sm={23} xs={23} lg={10} className=" top-20">
            <Row justify="end" al gutter={[0, 24]}>
              <Col span={24}>
                ...
                <Row gutter={[0, 24]} justify="end">
                  <Col span={22}>
                    <div className="text-xl sm:text-4xl font-black">
                      <span className="text-blue-700"> Business Directory</span>{" "}
                      Portal Connecting Buyers with Suppliers.
                    </div>
                  ...
                  <Col sm={22} xs={22} xl={0} xxl={0}>
                    <div className=" flex flex-col gap-5">
                      ...
                      <Button
                        disabled={isotp}
                        onClick={handleRedirectOTPLogin}
                        style={{color:'white', backgroundColor:'blue'}}
                      >
                        Continue
                      </Button>

                      <Button onClick={handleRedirectPasswordLogin} style={{color:'white', backgroundColor:'blue'}} >
                        Login with Password
                      </Button>
                    </div>
                  </Col>
                  ...
                  <Col xxl={22} sm={0} xs={0} xl={22}>
                    <div className="flex flex-col gap-5">
                      ...
                      <Button
                        onClick={handleRedirectPasswordLogin}
                        style={{color:'white', backgroundColor:'blue'}}
                        size="large"
                      >
                        Login with Password
                  ...
                  <Col span={22}>
                    <div className=" text-xs">
                      By proceeding, you consent to abide by our{" "}
                      <Link href="/about/Terms-Condition/">Terms of Use</Link>,{" "}
