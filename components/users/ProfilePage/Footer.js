...
<>
    {pathName.includes('/plan') || pathName.includes('/login') ? null :
        <div className="relative dark:text-black sm:rounded-2xl shadow-sm m-0 bg-white pt-6 pb-6">
                            ...
                            <Row justify='start' gutter={[{ xs: 8, sm: 8, md: 8, lg: 24, xl: 24 }, 12]}>
                                ...
                                <Col xs={0} sm={0} md={0} lg={24} xl={24} xxl={24}>
                                    <Row align='middle' gutter={[{ xs: 8, sm: 8, md: 8, lg: 24, xl: 24 }, 12]}>
                                        ...
                                        <Col span={3}>
                                            <Image src='https://mdwebzotica.famousbusiness.in/Payment_Image/visa.webp' width={200} height={200} alt='visa' />
                                        </Col>

                                        <Col span={3}>
                                            <Image src='https://mdwebzotica.famousbusiness.in/Payment_Image/payment.webp' width={200} height={200} alt='paytm' />
                                        </Col>

                                        <Col span={3}>
                                            <Image src='https://mdwebzotica.famousbusiness.in/Payment_Image/mastercard.webp' width={200} height={200} alt='master' />
                                        </Col>

                                        <Col span={3}>
                                            <Image src='https://mdwebzotica.famousbusiness.in/Payment_Image/upi.webp' width={200} height={200} alt='upi' />
                                        </Col>

                                        <Col span={3}>
                                            <Image src='https://mdwebzotica.famousbusiness.in/Payment_Image/paytm.webp' width={100} height={100} alt='paytm' />
                                        </Col>

                                        <Col span={3}>
                                            <Image src='https://mdwebzotica.famousbusiness.in/Payment_Image/google-pay.webp' width={100} height={100} alt='gpay' />
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
